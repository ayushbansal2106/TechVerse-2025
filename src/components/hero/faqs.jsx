      ...
      <div id="faqs" className="parent-faqs">
        ...
        <div className="faqs-section">
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              The fee for the Online project submisson is ₹300 per member.
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              The event has a prize pool of Rs 30,000 for the winners. Divided as follows
              <br />1st Prize - ₹15,000 <br />2nd Prize - ₹10,000 <br />3rd Prize - ₹5,000
            </p>
          </div>
          <div className="faqs-content" onClick={handleArrow}>
            <h1 className="faqs-content-title">

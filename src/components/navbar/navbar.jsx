...
const Navbar = () => {
  const handleInsta = () => {
    ...
    window.open("https://www.instagram.com/ayush_bansal.1929");
  ...
  const handleRegisterClick = () => {
    ...
    window.open("https://forms.gle/voWwW4dhvZsFTKMb7");
  };
          ...
          <div className="components-mobile">
            ...
            <div className="last-mobile">
              <h2 className="register-mobile">
                <a href="https://forms.gle/voWwW4dhvZsFTKMb7" target="_blank">
                  Register
                </a>
              </h2>
            </div>
